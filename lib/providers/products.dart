...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://myshop-93c69.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
      ...
      url =
          'https://myshop-93c69.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    //_items.add(value);
    final url =
        'https://myshop-93c69.firebaseio.com/products.json?auth=$authToken';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://myshop-93c69.firebaseio.com/products/$id.json?auth=$authToken';
